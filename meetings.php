...
<div class="container"> 
  ...
  <div class="row justify-content-center">
    ...
    <div class="col-7">
    <h1 class="center-text header-title" style="padding-top:30px;">Broadcast Educators Association </h1>
...
<ul class="nav justify-content-center" style="background-color: #0064b1;">
  <li class="nav-item">
      ...
      <div class="row">
        ...
        <div class="col-6 col-md">
          ...
          <ul class="list-unstyled text-small">
            ...
            <li><a class="text-white" href="#">Officers</a></li>
            <li><a class="text-white" href="#">Events</a></li>
            <li><a class="text-white" href="#">Meetings</a></li>
          </ul>
        </div>
        <div class="col-6 col-md">
          <h5>Follow Us</h5>
